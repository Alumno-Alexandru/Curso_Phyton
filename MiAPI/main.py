# para arancar uvicorn main:app --reload
...
# Codigio de la practica del csv
iesazarquiel = FastAPI(title="iesazarquiel")
...
# --- ENDPOINTS ---
#Para sacar la info de los alumnos
...
# Este codigo es para ver el porcentaje de asistencia
...
# Codigo para ver las notas a traves de las practicas o examenes realizados   
